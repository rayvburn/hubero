...
void BoundingEllipse::setPosition(const ignition::math::Vector3d &center_point) {
...
ignition::math::Vector3d BoundingEllipse::getCenterShifted() const {
...
void BoundingEllipse::updateCenter() {
