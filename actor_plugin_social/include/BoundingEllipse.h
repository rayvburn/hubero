...
#ifndef SRC_BOUNDINGELLIPSE_H_
#define SRC_BOUNDINGELLIPSE_H_
...
public:
	...
	BoundingEllipse();
	BoundingEllipse(const double &a_major, const double &b_minor, const double &yaw, const ignition::math::Vector3d &center_point,
