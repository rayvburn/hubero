...
private:
	...
	/**
	 * @brief A class which wraps a raw and safe positions of the point.
	 * The safe position is defined in terms of a corresponding costmap cell.
	 */
	...
	/**
	 * @brief Similar to the version of @ref setNewTarget overloaded method, which takes Vector3d and boolean arguments.
	 * @param target
	 * @param force_queue
	 * @return
	 ...
	 * @param target_lot: prospective new target structure, which contains safe and raw positions
	...
	/**
	 * @brief See @ref tryToApplyTarget for details. This version uses current pose
	 * of the actor as a start point.
	 * @param target_lot
	 * @return
	 */
...
public:
	...
	/// @brief A parameter defining the factor, by which the maximum distance
	/// from the actual point of interest is multiplied.
