...
public:
	...
	// TODO: doc FP + SC
	// aquisition during single social force computation
...
private:
	...
	/* Force vectors section */
	ignition::math::Vector3d force_internal_;		// a.k.a f_alpha
	ignition::math::Vector3d force_interaction_; 	// a.k.a sum of f_alpha_beta s
//	ignition::math::Vector3d force_social_;			// newly introduced force, generated by fuzzy logic system
	ignition::math::Vector3d force_combined_;		// result of summation
	...
	// values transfered to FuzzyProcessor and SocialConductor
	double dir_alpha_;
